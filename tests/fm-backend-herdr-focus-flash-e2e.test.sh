...
# Keep sleep a direct child of the pane shell on every supported shell. With
# `cd / && sleep 3000 &`, POSIX shells may background the whole AND-list in an
# intermediate shell, making the direct-child assertion below OS-dependent.
