...
4. **Acknowledge** using the independent address and roleplay axes in `AGENTS.md`.
   With no explicit preference on either axis, say: "Captain, away mode is active; I will batch routine updates and surface only decisions, failures, credentials, or review-ready work until you return."
